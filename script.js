...
<head>
    ...
    <style>
        ...
        .controls { position: absolute; bottom: 10px; left: 50%; transform: translateX(-50%); display: flex; flex-wrap: wrap; justify-content: center; }
        .slider-container { display: flex; align-items: center; margin: 5px; }
        .slider-label { margin-right: 10px; }
        .dropdown-container { position: absolute; top: 10px; left: 50%; transform: translateX(-50%); }
